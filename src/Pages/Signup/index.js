...
class Signup extends React.Component{
    ...
    Handelsubmit=()=>{
       fetch('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCTO26s0wjTmc5UUdDMrVnoK445K7c3LLI',{
        method: 'POST',
    ...
    return(
        <div>
          ...
          <div><Link to='/login'>Only For User:Login</Link></div>
        </div>
    )
 }
}
